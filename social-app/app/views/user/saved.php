...
<section class="chat-shell">
    <div class="chat-frame" style="grid-template-columns: 64px minmax(360px, 1fr);">
        ...
        <section class="chat-thread-panel">
            ...
            <div class="chat-message-scroll p-3">
                                ...
                                <a href="<?= BASE_URL ?>/post/<?= (int) ($post['id'] ?? 0) ?>" class="d-flex align-items-center gap-3 text-decoration-none text-dark flex-grow-1">
                                    ...
                                    <div>
                                        <div class="fw-semibold mb-1" style="max-width:600px;">
                                            <?= htmlspecialchars(mb_strimwidth((string) ($post['content'] ?? ''), 0, 110, '...')) ?>
                                        </div>
